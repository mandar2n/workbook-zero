...
public class QMemberMission extends EntityPathBase<MemberMission> {
    ...
    private static final long serialVersionUID = 403533753L;
    ...
    public final com.umc.workbook_zero.domain.QMember member;

    public final com.umc.workbook_zero.domain.QMission mission;

    public final EnumPath<com.umc.workbook_zero.domain.enums.MissionStatus> status = createEnum("status", com.umc.workbook_zero.domain.enums.MissionStatus.class);
    ...
    public QMemberMission(Class<? extends MemberMission> type, PathMetadata metadata, PathInits inits) {
        ...
        this.member = inits.isInitialized("member") ? new com.umc.workbook_zero.domain.QMember(forProperty("member")) : null;
        this.mission = inits.isInitialized("mission") ? new com.umc.workbook_zero.domain.QMission(forProperty("mission"), inits.get("mission")) : null;
    }
