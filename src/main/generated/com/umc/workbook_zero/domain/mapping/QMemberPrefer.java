...
public class QMemberPrefer extends EntityPathBase<MemberPrefer> {
    ...
    private static final long serialVersionUID = -1278686653L;
    ...
    public final com.umc.workbook_zero.domain.QFoodCategory foodCategory;
    ...
    public QMemberPrefer(Class<? extends MemberPrefer> type, PathMetadata metadata, PathInits inits) {
        ...
        this.foodCategory = inits.isInitialized("foodCategory") ? new com.umc.workbook_zero.domain.QFoodCategory(forProperty("foodCategory")) : null;
